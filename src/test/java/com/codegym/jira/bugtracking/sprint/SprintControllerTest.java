...
import static com.codegym.jira.bugtracking.sprint.SprintTestData.*;
import static com.codegym.jira.common.BaseHandler.REST_URL;
...
class SprintControllerTest extends AbstractControllerTest {
    ...
    void getNotFound() throws Exception {
        perform(MockMvcRequestBuilders.get(SPRINTS_REST_URL + UserTestData.NOT_FOUND))
    ...
    void getAllByProjectNotFound() throws Exception {
        perform(MockMvcRequestBuilders.get(SPRINTS_BY_PROJECT_REST_URL)
                .param(PROJECT_ID, String.valueOf(UserTestData.NOT_FOUND)))
                .andExpect(status().isNotFound());
    }
    ...
    void createWhenProjectNotExists() throws Exception {
        SprintTo notExistsProjectTo = new SprintTo(null, "new code", ACTIVE, UserTestData.NOT_FOUND);
        perform(MockMvcRequestBuilders.post(MNGR_SPRINTS_REST_URL)
                .contentType(MediaType.APPLICATION_JSON)
    ...
    void updateWhenProjectNotExists() throws Exception {
        SprintTo notExistsProjectTo = new SprintTo(SPRINT1_ID, "updated code", ACTIVE, UserTestData.NOT_FOUND);
        perform(MockMvcRequestBuilders.put(MNGR_SPRINTS_REST_URL_SLASH + SPRINT1_ID)
                .contentType(MediaType.APPLICATION_JSON)
                .content(writeValue(notExistsProjectTo)))
                .andDo(print())
    ...
    void changeStatusCodeNotFound() throws Exception {
        perform(MockMvcRequestBuilders.patch(MNGR_SPRINTS_REST_URL_SLASH + UserTestData.NOT_FOUND + "/change-status")
                .param(STATUS_CODE, ACTIVE))
                .andDo(print())
                .andExpect(status().isNotFound());
    }
    ...
    void enableNotFound() throws Exception {
        perform(MockMvcRequestBuilders.patch(MNGR_SPRINTS_REST_URL_SLASH + UserTestData.NOT_FOUND)
                .param(ENABLED, "true"))
                .andExpect(status().isNotFound());
    }
