package com.codegym.jira.common.internal.web;

import com.codegym.jira.common.error.*;
...
// more specific first
    ...
    protected <T> T processException(@NonNull Exception ex, @Nullable HttpServletRequest request, String path, Processor<T> processor) {
        ...
        if (type.isPresent()) {
            ...
            return processor.process(ex, ErrorType.APP_ERROR, "Exception " + root.getClass().getName(), request);
        }
    }
